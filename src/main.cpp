...
void initialize() {
  ...
  ez::as::auton_selector.autons_add({
      ...
      {"Blue Right Side\n\nMatchload, Score 4 Blocks, Wing", BlueleftFourBlocks},
...
const int DOWN_ANGLE = 350;
const int UP_ANGLE = 220; // Example: 450 degrees
...
void opcontrol() {
  ...
  pros::Task lever_task(leverState,"Lever Task");
  // pros::Task discore_task(setDescoreAngle, "Discore Task");
  ...
  //Second Try if Ever
      ...
      matchLoad.button_toggle(master.get_digital(DIGITAL_UP));
